(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.myQueryUI = factory());
    ...
    $.fn.autocomplete = function (options) {
      ...
      return this.each(function () {
        ...
        $input.on('input', function () {
          ...
          // 筛选匹配项
          const matches = settings.source.filter(item => item.toLowerCase().includes(term));
